...
aliases:
  - /factory-score/
title: '🚦 Developed countries score the machine, not your life'
type: 'claims'
...
grounding: >-
  **HDI** blends life expectancy, schooling, and income per capita; UNDP says it only
  partly captures human development and leaves out inequality, poverty, and empowerment.
  Critics also stress it skips ecological limits. **World Happiness Report** scores use
  a 0-10 life-evaluation ladder driven mainly by GDP per capita, health, social support,
  freedom, generosity, and corruption (Cantril-style inputs).
  **Source:** [Human Development Index (UNDP data center)](https://hdr.undp.org/data-center/human-development-index),
  [Sagar & Najam 1998](https://www.belfercenter.org/publication/human-development-index-critical-review),
  [World Happiness Report methodology](https://www.worldhappiness.report/about/)
...
Let's give it a name: **well-serviced factories**. They are [systems built to last]({{< ref "social-protocols/2026-05-05-built-to-last" >}}) (a high bar for a machine, but **not the same as a developed society**).
...
{{< image src="factory.webp" alt="Split dashboard: system health gauges at 100% for GDP per capita, life expectancy, and schooling; human reality monitors flatlined for human connection, true empowerment, and ecological limits" linked=false >}}
