...
title: "💊🌀 Why might someone pass exams on LSD without notes?"
type: claims
description: |
...
aliases:
  - /mind-infrastructure/2026-05-29-lsd-plasticity-overfitting/
...
{{< image src="lsd-cognitive-effects.webp" alt="Infographic from an LSD dose: three arrows for memory improvement (enhanced episodic recall), verbal fluency (faster word retrieval), and cognitive flexibility (reduced rule-switching on tasks like the Wisconsin Card Sorting Test)" linked=false >}}
