...
type: claims
description: |
  Brains compress the world into **layers and rank**, then route attention upward, so local noise gets summarized before it reaches a decision. That is why pyramid-like groups feel obvious: a few signals at the top, many roles below, a ladder everyone can read. **Hierarchy is an attractor**: groups keep sliding into a pyramid. Flatter systems need counter-design (written rules and shared maps), because the nervous system is already used to climbing.
grounding: |
  Human functional MRI (brain imaging; Zink et al., 2008) shows the brain **automatically tracks social rank** and treats status wins and losses like rewards worth chasing. Layered cortex (stacked maps from simple features up to goals) is one reason pyramid orgs are easy to read before anyone defends them. **Source:** [Know Your Place: Neural Processing of Social Hierarchy in Humans](https://pmc.ncbi.nlm.nih.gov/articles/PMC2430590/) (PubMed Central).
draft: false

aliases:
  - /pyramids/
  - /human-condition/2026-05-22-why-humans-keep-building-pyramids/
  - /human-condition/2026-05-29-why-humans-keep-building-pyramids/
...
{{< image src="org.jpg" alt="Company pyramid funnel: many voices at the base narrow through managers to one executive bullet at the top" linked=false >}}
