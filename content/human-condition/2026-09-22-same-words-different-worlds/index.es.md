...
El problema empieza cuando la vida de uno de los dos cambia y la conversación se queda igual. Alguien asume nuevas responsabilidades, deja atrás viejos hábitos o decide que ya no tolera una dinámica antigua. Si nunca dice ese cambio en voz alta, la otra persona sigue reconstruyendo su imagen desde una **versión caduca** de quién era. El conflicto es el **mecanismo que corrige** ese modelo viejo. Cuando alguien marca un límite nuevo o explica cómo le pegó una acción concreta, aporta los datos que faltaban. Una persona dice: "Ahora esto es lo que necesito", y la otra absorbe ese hecho en su reconstrucción de la mente del otro. Así la **realidad compartida** no se convierte en un **museo de supuestos obsoletos**.
