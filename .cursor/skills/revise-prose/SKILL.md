...
description: >-
  ...
  AI artifacts; does not rewrite content. Triggers: /revise-prose, revise-prose,
  local prose review, local evaluate, bar-test critique, human-friendliness score,
  evaluate-only.
---
...
- **Slash command:** `/revise-prose` (see `.cursor/commands/revise-prose.md`)
- local prose review / local evaluate
