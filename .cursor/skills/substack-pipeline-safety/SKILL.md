...
- **Substack body** requires **`substack.md`** / **`substack.es.md`** (locale paired with **`index.md`** / **`index.es.md`**). No fallback to index body or **`facebook-*`** sidecars. Front matter (date, tags, cover) always comes from the index file. Authoring: **`.cursor/skills/substack-post/SKILL.md`**.
