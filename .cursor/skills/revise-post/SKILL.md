...
| Cadence only | `.cursor/skills/revise-flow/SKILL.md` |
| Hooks only | `.cursor/skills/revise-hooks/SKILL.md` |
| Site checklist only (no heavy/fine flow) | **This skill**, mode **`checklist`** |
| Em dash + emphasis only | `.cursor/skills/revise-format/SKILL.md` |
| Score gate | `.cursor/skills/revise-score/SKILL.md` (optional phase) |
| Spanish sibling | `.cursor/skills/revise-post-es/SKILL.md` (after English) |
...
**Read first:** `.cursor/skills/revise-hooks/SKILL.md` for hook patterns and forbidden tone. For type-specific lead rules, read the relevant type skill (`.cursor/skills/video-content/SKILL.md` or `.cursor/skills/claims-content/SKILL.md`) before evaluating.
...
- MUST apply **`.cursor/skills/revise-hooks/SKILL.md`** → **Claim fog (abstract cold-read fail)**.
...
If this gate fails, Step 1 status is **Fix Needed** even when the **title** hooks. See **`.cursor/skills/video-content/SKILL.md`** → **Cold-read gate**.

**List copy and body headings (all types with markdown body):**

- [ ] List-facing fields **cold-read** per **`.cursor/skills/revise-hooks/SKILL.md`** → **Capture vs pass** and **Cold-read** (claims: Claim + grounding; video: see video-content gate too).
...
- See **`.cursor/skills/revise-hooks/SKILL.md`** → **Body headings (`##` and `###`) — hooks, not labels**.
...
**Full banned-pattern tables, Explanatory prose, and clever-filler examples:** **`.cursor/skills/revise-post/reference.md`**. MUST apply that reference when scrubbing.
...
**Note:** When the post covers AI, neuroscience, or cognitive science, also read `.cursor/skills/ai-for-general-audience/SKILL.md` for plain-language equivalents of common jargon.
...
- Re-apply **`.cursor/skills/video-content/SKILL.md`** → **Cold-read gate** before marking Step 3 Pass.
...
**MUST run** **`.cursor/skills/revise-format/SKILL.md`** (em dash search + **emphasis** audit per **revise-emphasis**). Step 4 is **Fix Needed** if either mandatory search was skipped or em dash hits &gt; 0.
...
- `type: video` → `.cursor/skills/video-content/SKILL.md`
- `type: claims` → `.cursor/skills/claims-content/SKILL.md`
- `type: panel` / `type: sayings` → `.cursor/skills/cognitive-memetics-content/SKILL.md`
