...
- Read **`.cursor/skills/tag-register/SKILL.md`** and the current **`data/tag-register.txt`**.
...
4. **Bilingual:** For bundles with **`index.es.md`**, MUST mirror the same **`tags`** list as **`index.md`** (see **`.cursor/skills/spanish-translation-content/SKILL.md`**).
