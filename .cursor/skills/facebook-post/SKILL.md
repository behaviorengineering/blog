...
On Hugo **`type: sayings`** bundles (and other cognitive-memetics series that carry **`tldr`** / **`fluff`** in front matter), the site field is still named **`fluff`**. LinkedIn uses a labeled block **`➕ Context:`** for that material (never **`➕ FLUFF:`**); see **`.cursor/skills/linkedin-post/SKILL.md`** → **Section label: Context**.
...
| **`substack.md`** / **`substack.es.md`** | Adapted prose with **`##`** hooks; no **`➕ Context:`** label ( **`.cursor/skills/substack-post/SKILL.md`** ) |
...
- SHOULD run **`.cursor/skills/revise-post/SKILL.md`** → **Step 2** (standalone worth): cut warmups with no claim, merge redundant beats, one sharp image per metaphor block.
...
- **Omit `MM:SS` and `t=` URLs** on every Facebook row (same rationale as **`.cursor/skills/linkedin-post/SKILL.md`** → **Video chapter guide (TOC)**).
...
| `substack.md` / `substack.es.md` | Full table ( **`.cursor/skills/substack-post/SKILL.md`** ) |
| `linkedin.txt` | `• Label · topic`, no times ( **`.cursor/skills/linkedin-post/SKILL.md`** ) |
| `facebook-en.txt` / `facebook-es.txt` | Same outline shape as LinkedIn; **friends** body and headings per locale |

### Reference bundle

**`content/mind-infrastructure/2026-05-21-brain-is-not-a-computer/`** (`facebook-en.txt`, `facebook-es.txt`). See **`.cursor/skills/video-content/SKILL.md`** for site table authoring.
...
Newsletter bodies live in **`substack.md`** / **`substack.es.md`**, not in facebook sidecars. See **`.cursor/skills/substack-post/SKILL.md`**.
...
- **Substack:** `.cursor/skills/substack-post/SKILL.md`
- **Standalone worth (compression pass):** `.cursor/skills/revise-post/SKILL.md` → **Step 2**
- **Video picks (site chapter table):** `.cursor/skills/video-content/SKILL.md`
- **Spanish naturalness audit:** `.cursor/skills/revise-spanish/SKILL.md`
- **Spanish revision:** `.cursor/skills/revise-post-es/SKILL.md`
- **LinkedIn (English, professional):** `.cursor/skills/linkedin-post/SKILL.md`
- **Spanish site pages:** `.cursor/skills/spanish-translation-content/SKILL.md`
