...
Applies **only** to **`substack.md`** and **`substack.es.md`**, not to `index.md`, `linkedin.txt`, `facebook-*.txt`, or Hugo site body. Pair with **`.cursor/skills/revise-emphasis/SKILL.md`** for density (restrained, not wall-to-wall).
...
- Match emphasis placement to the English sidecar when bilingual, but keep idiomatic Spanish wording per **`.cursor/skills/spanish-translation-content/SKILL.md`**.
...
- **Why:** Newsletter readers often skim text first; timestamped jumps are high value and match the site pick (see **`.cursor/skills/video-content/SKILL.md`**).
...
- **Video picks (site Chapter guide):** `.cursor/skills/video-content/SKILL.md`
- **Emphasis density:** `.cursor/skills/revise-emphasis/SKILL.md`
- **Friends Facebook:** `.cursor/skills/facebook-post/SKILL.md`
- **LinkedIn:** `.cursor/skills/linkedin-post/SKILL.md`
- **Spanish bundles:** `.cursor/skills/spanish-translation-content/SKILL.md`
- **Pipeline safety:** `.cursor/skills/substack-pipeline-safety/SKILL.md`
