...
**Audit existing titles:** **`.cursor/skills/revise-hooks/SKILL.md`**.  
...
**Claim fog check:** After picking a title, read the **Claim** per **`.cursor/skills/revise-hooks/SKILL.md`** → **Claim fog**. Title can be perfect while a Claim sentence still fails cold-read; fix the Claim before publish.
...
- **`.cursor/skills/revise-hooks/SKILL.md`** — audit, integrity, body headings
- **`.cursor/skills/claims-content/SKILL.md`** — Claim must stay assertion
- **`.cursor/skills/revise-post/SKILL.md`** — full lot after title is set (hooks phase)
- **`.cursor/skills/curiosity-title/examples.md`** — more before/after pairs (optional read)
