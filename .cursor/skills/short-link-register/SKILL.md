...
- Carousel CTA authoring: **`.cursor/skills/carousel-post/SKILL.md`** → **Post CTA short link**
- Tag inventory (similar pattern): **`.cursor/skills/tag-register/SKILL.md`**
